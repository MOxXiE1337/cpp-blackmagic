...
//
// Current role:
// - Default-argument metadata registry (generated by inject.py)
//
// Runtime explicit overrides are context-scoped and live in runtime/context.h.
...
namespace cpp::blackmagic::depends
{
    ...
    // Key used by runtime context-scoped explicit overrides.
    // target == nullptr means context-wide fallback value.
